<div>
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="mb-0"><i class="ri ri-calendar-line me-2"></i>Editar Lapso: {{ $period->name }}</h5>
        </div>
        <div class="card-body">
            <form wire:submit="save">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input type="checkbox" id="is_closed" class="form-check-input" wire:model="is_closed">
                            <label for="is_closed" class="form-check-label">Cerrado (No permite modificar notas)</label>
                        </div>
                    </div>
                </div>
