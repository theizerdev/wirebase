            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="card-title mb-1">Nuevo Pastor</h5>
                            <p class="mb-0">Registre un nuevo pastor en el sistema</p>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('searchConyuge') is-invalid @enderror"
                                           wire:model.debounce.300ms="searchConyuge"
                                        ...
                                        @if($conyuge_id)
                                            ...
                                            @if($selected)
                                                <div class="d-flex align-items-center gap-3 p-2 border rounded">
                                                    ...
                                                    @endphp
                                                    @if($fotoUrl)
                                                        <img src="{{ $fotoUrl }}" alt="Foto" class="rounded-circle" style="width:48px;height:48px;object-fit:cover;">
                                                    @else
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary" wire:click.prevent="showPastorProfile({{ $selected->id }})" title="Ver perfil">
                                                            Ver
                                                        </button>
