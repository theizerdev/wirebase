<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Editar Zona</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Actualice los datos de la zona</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <form wire:submit="update">
                ...
                <div class="mb-4">
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Deje en blanco para una zona global de empresa</p>
                    @error('sucursal_id')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    >
                        <span wire:loading.remove wire:target="update">Actualizar Zona</span>
