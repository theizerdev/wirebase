            ...
            <div class="col-lg-12 col-xl-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-transparent border-0 pb-0">
                        <h5 class="mb-0"><i class="ri ri-home-heart-line me-2 text-primary"></i>Moficar Casa de Alimentación</h5>
                    </div>
        <div class="card-body">
                        <!-- Step Indicator -->
                        ...
                        <form wire:submit.prevent="save">
                                        ...
                                        <div class="row g-3 mb-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select form-select-sm @error('municipio_id') is-invalid @enderror"
                                                        wire:model.change="municipio_id" {{ empty($municipios) ? 'disabled' : '' }}>
                                                    <option value="">-- Seleccione --</option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select form-select-sm @error('parroquia_id') is-invalid @enderror"
                                                        wire:model.change="parroquia_id" {{ empty($parroquias) ? 'disabled' : '' }}>
                                                    <option value="">-- Seleccione --</option>
                                        ...
                                        <div class="row g-3 mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select form-select-sm @error('estado_cda') is-invalid @enderror"
                                                        wire:model.live="estado_cda" required>
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-6">
                                                <label class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" wire:model.live="zona_base_misiones">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" step="0.01" class="form-control form-control-sm"
                                                       wire:model="distancia_a_base_misiones" placeholder="Ej: 2.5" @error('distancia_a_base_misiones') is-invalid @enderror>
                                                @error('distancia_a_base_misiones') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                            </div>
                                        </div>
                                        @if ($estado_cda ==  'Inoperativa')
                            ...
                            <div class="wizard-step active">
                                ...
                                <div class="border-top pt-3 mt-4">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="button" wire:click="nextStep" class="btn btn-sm btn-success">
                                            Siguiente <i class="ri ri-arrow-right-line ms-1"></i>
                                        </button>
                                    </div>
                                </div>
                            ...
                            @if($currentStep === 3)
                            <div class="wizard-step active">
                                <h6 class="fw-semibold mb-3 text-primary"><i class="ri ri-building-4-line me-2"></i>Paso 3: Infraestructura de la Cocina</h6>

                                <div class="border rounded p-3 mb-3">
                                    <h6 class="fw-semibold mb-3 small text-uppercase text-muted">Condiciones de Infraestructura</h6>

                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">Condición Fachada</label>
                                            <select class="form-select form-select-sm @error('condicion_fachada') is-invalid @enderror" wire:model="condicion_fachada">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Pintada">Pintada</option>
                                                <option value="Frisada">Frisada</option>
                                                <option value="Sin Frisar">Sin Frisar</option>
                                            </select>
                                            @error('condicion_fachada') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">Condición Área de Cocina</label>
                                            <select class="form-select form-select-sm @error('condicion_area_cocina') is-invalid @enderror" wire:model="condicion_area_cocina">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Buena">Buena</option>
                                                <option value="Regular">Regular</option>
                                                <option value="Mala">Mala</option>
                                            </select>
                                            @error('condicion_area_cocina') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">Condición Despensa</label>
                                            <select class="form-select form-select-sm @error('condicion_despensa') is-invalid @enderror" wire:model="condicion_despensa">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Buena">Buena</option>
                                                <option value="Regular">Regular</option>
                                                <option value="Mala">Mala</option>
                                            </select>
                                            @error('condicion_despensa') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">Condición Cableado Eléctrico</label>
                                            <select class="form-select form-select-sm @error('condicion_cableado_electrico') is-invalid @enderror" wire:model="condicion_cableado_electrico">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Buena">Buena</option>
                                                <option value="Regular">Regular</option>
                                                <option value="Mala">Mala</option>
                                            </select>
                                            @error('condicion_cableado_electrico') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">Condición Aguas Servidas</label>
                                            <select class="form-select form-select-sm @error('condicion_aguas_servidas') is-invalid @enderror" wire:model="condicion_aguas_servidas">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Buena">Buena</option>
                                                <option value="Regular">Regular</option>
                                                <option value="Mala">Mala</option>
                                            </select>
                                            @error('condicion_aguas_servidas') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">Condición Agua Potable</label>
                                            <select class="form-select form-select-sm @error('condicion_agua_potable') is-invalid @enderror" wire:model="condicion_agua_potable">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Buena">Buena</option>
                                                <option value="Regular">Regular</option>
                                                <option value="Mala">Mala</option>
                                            </select>
                                            @error('condicion_agua_potable') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">Condición del Techo</label>
                                            <select class="form-select form-select-sm @error('condicion_techo') is-invalid @enderror" wire:model="condicion_techo">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Buena">Buena</option>
                                                <option value="Regular">Regular</option>
                                                <option value="Mala">Mala</option>
                                            </select>
                                            @error('condicion_techo') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">Condición del Piso</label>
                                            <select class="form-select form-select-sm @error('condicion_piso') is-invalid @enderror" wire:model="condicion_piso">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Buena">Buena</option>
                                                <option value="Regular">Regular</option>
                                                <option value="Mala">Mala</option>
                                            </select>
                                            @error('condicion_piso') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">Condición de las Paredes</label>
                                            <select class="form-select form-select-sm @error('condicion_paredes') is-invalid @enderror" wire:model="condicion_paredes">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Buena">Buena</option>
                                                <option value="Regular">Regular</option>
                                                <option value="Mala">Mala</option>
                                            </select>
                                            @error('condicion_paredes') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-semibold small">Observaciones</label>
                                    <textarea class="form-control form-control-sm @error('observaciones_infraestructura_cocina') is-invalid @enderror"
                                              wire:model="observaciones_infraestructura_cocina" rows="3"
                                              placeholder="Observaciones adicionales sobre la infraestructura de la cocina"></textarea>
                                    @error('observaciones_infraestructura_cocina') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                            ...
                            @if($currentStep === 4)
                            <div class="wizard-step active">
                                <h6 class="fw-semibold mb-3 text-primary"><i class="ri ri-store-3-line me-2"></i>Paso 4: Socio Productivo (Factibilidad de espacio)</h6>

                                <div class="border rounded p-3 mb-3">
                                    <h6 class="fw-semibold mb-3 small text-uppercase text-muted">Datos de Factibilidad</h6>

                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">El espacio donde funciona la Casa</label>
                                            <select class="form-select form-select-sm @error('espacio_casa_alimentacion') is-invalid @enderror" wire:model="espacio_casa_alimentacion">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Propio">Propio</option>
                                                <option value="De uso comunal">De uso comunal</option>
                                            </select>
                                            @error('espacio_casa_alimentacion') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">¿Ha recibido formación?</label>
                                            <select class="form-select form-select-sm @error('ha_recibido_formacion_proyectos') is-invalid @enderror" wire:model="ha_recibido_formacion_proyectos">
                                                <option value="">-- Seleccione --</option>
                                                <option value="si">si</option>
                                                <option value="no">no</option>
                                            </select>
                                            @error('ha_recibido_formacion_proyectos') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small">¿Posee proyecto socio productivo?</label>
                                            <select class="form-select form-select-sm @error('posee_proyecto_socio_productivo') is-invalid @enderror" wire:model="posee_proyecto_socio_productivo">
                                                <option value="">-- Seleccione --</option>
                                                <option value="si">si</option>
                                                <option value="no">no</option>
                                            </select>
                                            @error('posee_proyecto_socio_productivo') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">¿Interesado en emprender producción primaria?</label>
                                            <select class="form-select form-select-sm @error('interesado_produccion_primaria') is-invalid @enderror" wire:model="interesado_produccion_primaria">
                                                <option value="">-- Seleccione --</option>
                                                <option value="Si">Si</option>
                                                <option value="No">No</option>
                                                <option value="si">si</option>
                                            ...
                                            @error('interesado_produccion_primaria') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">¿Cuenta con infraestructura adecuada?</label>
                                            <select class="form-select form-select-sm @error('cuenta_infraestructura_adecuada_proyecto') is-invalid @enderror" wire:model="cuenta_infraestructura_adecuada_proyecto">
                                                <option value="">-- Seleccione --</option>
                                                <option value="SI">SI</option>
                                                <option value="NO">NO</option>
                                                <option value="si">si</option>
                                            ...
                                            @error('cuenta_infraestructura_adecuada_proyecto') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">Metros cuadrados</label>
                                            <input type="number" step="0.01" class="form-control form-control-sm @error('metros_cuadrados_proyecto') is-invalid @enderror" wire:model="metros_cuadrados_proyecto" placeholder="Ej: 50.00">
                                            @error('metros_cuadrados_proyecto') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">Observaciones</label>
                                            <textarea class="form-control form-control-sm @error('observaciones_factibilidad_proyecto') is-invalid @enderror"
                                                      wire:model="observaciones_factibilidad_proyecto" rows="3"
                                                      placeholder="Observaciones"></textarea>
                                            @error('observaciones_factibilidad_proyecto') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if($currentStep === 5)
                            <div class="wizard-step active">
                                <h6 class="fw-semibold mb-3 text-primary"><i class="ri ri-file-list-3-line me-2"></i>Paso 5: Ficha Técnica</h6>

                                <div class="border rounded p-3 mb-3">
                                    <h6 class="fw-semibold mb-3 small text-uppercase text-muted">Datos de la Ficha Técnica</h6>

                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">Encuestador (Nombre y apellido)</label>
                                            <input type="text" class="form-control form-control-sm @error('encuestador_nombre') is-invalid @enderror" wire:model="encuestador_nombre" placeholder="Nombre y apellido">
                                            @error('encuestador_nombre') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">Encuestador (Teléfono)</label>
                                            <input type="text" class="form-control form-control-sm @error('encuestador_telefono') is-invalid @enderror" wire:model="encuestador_telefono" placeholder="Número telefónico">
                                            @error('encuestador_telefono') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">Técnico (Nombre y apellido)</label>
                                            <input type="text" class="form-control form-control-sm @error('tecnico_nombre') is-invalid @enderror" wire:model="tecnico_nombre" placeholder="Nombre y apellido">
                                            @error('tecnico_nombre') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">Técnico (Teléfono)</label>
                                            <input type="text" class="form-control form-control-sm @error('tecnico_telefono') is-invalid @enderror" wire:model="tecnico_telefono" placeholder="Número telefónico">
                                            @error('tecnico_telefono') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">Transcriptor (Nombre y apellido)</label>
                                            <input type="text" class="form-control form-control-sm @error('transcriptor_nombre') is-invalid @enderror" wire:model="transcriptor_nombre" placeholder="Nombre y apellido">
                                            @error('transcriptor_nombre') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small">Transcriptor (Teléfono)</label>
                                            <input type="text" class="form-control form-control-sm @error('transcriptor_telefono') is-invalid @enderror" wire:model="transcriptor_telefono" placeholder="Número telefónico">
                                            @error('transcriptor_telefono') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="col-12">
                                            <label class="form-label fw-semibold small">Observaciones adicionales</label>
                                            <textarea class="form-control form-control-sm @error('observaciones_adicionales_ficha_tecnica') is-invalid @enderror"
                                                      wire:model="observaciones_adicionales_ficha_tecnica" rows="4"
                                                      placeholder="Observaciones adicionales"></textarea>
                                            @error('observaciones_adicionales_ficha_tecnica') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="border-top pt-3 mt-4">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-success">
                                            <i class="ri ri-save-line me-1"></i> Actualizar Casa de Alimentación
                                        </button>
                                    </div>
                                </div>
                            </div>
