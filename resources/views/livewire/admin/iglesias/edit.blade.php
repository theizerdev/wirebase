                        ...
                        @if($currentStep == 1)
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select" wire:model.change="pastor_id">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function obtenerCoordenadasFormulario() {
        const latInput = document.querySelector('input[wire\\:model\\.change="latitud"]');
        const lngInput = document.querySelector('input[wire\\:model\\.change="longitud"]');
    ...
    async function actualizarCoordenadas(lat, lng) {
        ...
        if (direccion) {
            ...
            const direccionTextarea = document.querySelector('textarea[wire\\:model\\.change="direccion"]');
