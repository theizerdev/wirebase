        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                    <h5 class="mb-1">Nuevo Ítem de Inventario</h5>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.0001" class="form-control {{ !$tasa_bcv ? 'is-warning' : '' }}" wire:model.live="tasa_bcv" min="0" placeholder="Ej: 36.5000" {{ $loadingRate ? 'disabled' : '' }}>
