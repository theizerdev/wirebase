    ...
    <div class="inventario-hero d-flex flex-wrap align-items-center justify-content-between gap-3">
        <div>
            <h2 class="fw-semibold mb-2">
                <i class="ri ri-add-line me-2"></i>Nuevo Ítem de Inventario
            </h2>
            <p class="mb-0 opacity-75">Agregar un nuevo bien o activo al inventario</p>
        </div>
            ...
            <form wire:submit="save">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="ri ri-save-line me-1"></i>Guardar Ítem
                    </button>
                </div>
            </form>
        </div>
