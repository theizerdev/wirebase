        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-0">Registrar Nueva Unidad</h5>
                        <p class="mb-0 text-muted">Añadir una nueva motocicleta al inventario</p>
                    </div>
                ...
                <div class="card-body">
                    <form wire:submit="save">
                        <div class="row g-3">
                            <!-- Ubicación -->
                            <div class="col-12">
                                <h6 class="fw-bold text-primary">Ubicación y Modelo</h6>
                                <hr class="mt-0">
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating form-floating-outline">
                                    <select wire:model.live="moto_id" id="moto_id" class="form-select @error('moto_id') is-invalid @enderror">
                                        <option value="">Seleccione un modelo...</option>
                                        @foreach($motos as $moto)
                                            <option value="{{ $moto->id }}">{{ $moto->titulo }} ({{ $moto->marca }} {{ $moto->modelo }})</option>
                                        @endforeach
                                    </select>
                                    <label for="moto_id">Modelo de Motocicleta</label>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('admin.inventario.unidades.index') }}" class="btn btn-label-secondary">Cancelar</a>
