<div>
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="mb-0"><i class="ri ri-file-add-line me-2"></i>Crear Nueva Evaluación</h5>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select id="evaluation_type_id" class="form-select @error('evaluation_type_id') is-invalid @enderror" wire:model.live="evaluation_type_id">
                            <option value="">Seleccione...</option>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" wire:model="name" placeholder="Ej: Examen Parcial 1">
