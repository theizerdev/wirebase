    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <button type="button" wire:click="aplicarPlantilla('inicial')" class="btn btn-outline-success" title="Plantilla Inicial">
                            <i class="ri ri-user-add-line"></i>
                        </button>
                        <button type="button" wire:click="aplicarPlantilla('mora')" class="btn btn-outline-danger" title="Plantilla Mora">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        @if($busqueda_cliente && count($clientes_filtrados) > 0)
                            ...
                            <div class="p-2 border-bottom cursor-pointer hover-bg-light"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="fw-medium">{{ $cliente->nombre_completo }}</div>
                        ...
                        @elseif($busqueda_cliente && count($clientes_filtrados) === 0)
                        <div class="alert alert-warning mt-2 mb-0">
                            <i class="ri ri-search-line me-1"></i> No se encontraron clientes con "{{ $busqueda_cliente }}"
                        </div>
                        @endif
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <span class="fw-medium">{{ $cliente->telefono ?? 'N/A' }}</span>
                                    </div>
                                    <div class="col-6">
                                        <small class="d-block text-muted">Dirección</small>
                                        <span class="fw-medium text-truncate d-block" title="{{ $cliente->direccion }}">{{ $cliente->direccion ?? 'N/A' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @endif
                        ...
                        {{-- Historial de pagos --}}
                        @if($cliente_id && count($pagos_anteriores) > 0)
                        <div class="card mt-3">
                            ...
                            <div class="card-body py-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center py-1 {{ !$loop->last ? 'border-bottom' : '' }}">
                                    ...
                                    <div class="text-end">
                                        <span class="fw-bold text-success">${{ number_format($pago->total, 2) }}</span>
                    ...
                    @if(!$cliente_id)
                        <div class="border rounded p-4 text-center mt-3">
                            ...
                            <p class="text-muted mb-0">Seleccione un cliente</p>
                            <small class="text-muted">para ver la información y contratos</small>
                        </div>
                    @endif
                </div>
            </div>
          ...
          <div class="col-lg-6 mb-4">
              ...
              @if($cliente_id && count($contratos) > 0)
                  <div class="card mb-3">
                      <div class="card-body">
                          <label class="form-label">Seleccionar Contrato</label>
                          <select wire:model.live="contrato_id" class="form-select @error('contrato_id') is-invalid @enderror">
                              <option value="">-- Seleccione un contrato --</option>
                              @foreach($contratos as $contrato)
                                  <option value="{{ $contrato->id }}">
                                      Contrato #{{ $contrato->id }} - {{ $contrato->unidad->moto->modelo ?? 'Moto' }} ({{ $contrato->estado }})
                                  </option>
                              @endforeach
                          </select>
                      </div>
              ...
              @if($contrato_id && count($cuotasPendientes) > 0)
            <div class="card">
                <div class="card-header">
                            ...
                            <div class="border rounded p-3 mb-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="text-end">
                                        ...
                                        @if($cuota->mora_calculada > $cuota->mora_pagada)
                                            <div class="text-danger small">+ Mora: ${{ number_format($cuota->mora_calculada - $cuota->mora_pagada, 2) }}</div>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <button wire:click="guardar"
                                            ...
                                            @if($this->total <= 0 || !$cliente_id || !$this->serie_actual || ($es_pago_mixto && $this->totalPagoMixto != $this->total)) disabled @endif>
