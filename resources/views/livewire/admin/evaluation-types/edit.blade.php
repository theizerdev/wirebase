<div>
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="mb-0"><i class="ri ri-list-check me-2"></i>Editar Tipo: {{ $type->name }}</h5>
        </div>
        <div class="card-body">
            <form wire:submit="save">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" id="code" class="form-control @error('code') is-invalid @enderror" wire:model="code" maxlength="20">
