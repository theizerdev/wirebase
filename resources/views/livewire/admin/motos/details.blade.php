<div x-data>
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0">Detalles de contratos y pagos</p>
            </div>
            <div class="d-flex gap-2">
                ...
                <button class="btn btn-primary" wire:click="loadData">
                    <i class="ri ri-bar-chart-line me-1"></i> Cargar información
                </button>
            </div>
        </div>
    </div>
    ...
    @if(!$lazyLoaded)
        <div class="alert alert-info">Haz clic en “Cargar información” para traer contratos y pagos (lazy load).</div>
    @else
    <div class="row mb-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr><td colspan="5" class="text-muted text-center">Sin pagos registrados</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
