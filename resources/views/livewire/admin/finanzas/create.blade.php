    ...
    <div class="finanzas-hero d-flex flex-wrap align-items-center justify-content-between gap-3">
        <div>
            <h2 class="fw-semibold mb-2">
                <i class="ri ri-add-line me-2"></i>Nueva Transacción Financiera
            </h2>
            <p class="mb-0 opacity-75">Registrar diezmos, ofrendas o gastos</p>
        </div>
            ...
            <form wire:submit="save">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   class="form-control" 
                                   wire:model.live.debounce.300ms="montoVes"
                                   min="0"
                                   step="0.01"
                                   placeholder="0.00">
                        </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="ri ri-save-line me-1"></i>Guardar Transacción
                    </button>
                </div>
            </form>
        </div>
