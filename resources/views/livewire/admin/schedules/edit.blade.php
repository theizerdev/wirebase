                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('company_id') is-invalid @enderror" id="company_id" wire:model="company_id">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('branch_id') is-invalid @enderror" id="branch_id" wire:model="branch_id" @disabled(!$company_id)>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('section_id') is-invalid @enderror" id="section_id" wire:model="section_id" @disabled(!$company_id || !$branch_id)>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('classroom_id') is-invalid @enderror" id="classroom_id" wire:model="classroom_id" @disabled(!$company_id || !$branch_id)>
