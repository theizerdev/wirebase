<div>
    ...
    <div class="container-p-y">
        ...
        <div class="row gy-3">
            <div class="col-md-8">
                <div class="card">
                    <h5 class="card-header">Editar Parroquia</h5>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="info-list">
                            <p class="mb-3">
                                ...
                                <span class="fw-medium">Parroquia: {{ $parroquia->nombre }}</span>
                            </p>
                            <p class="small text-muted">
                                <i class="ri ri-map-pin-line me-1"></i>
                                <strong>Municipio:</strong> {{ $parroquia->municipio->nombre ?? 'N/A' }}
                            </p>
                            <p class="small text-muted">
                                <i class="ri ri-map-pin-2-line me-1"></i>
                                <strong>Estado:</strong> {{ $parroquia->municipio->estado->nombre ?? 'N/A' }}
                            </p>
                            <p class="small text-muted">
                                <i class="ri ri-profile-line me-1"></i>
                                <strong>Estado actual:</strong> 
                                <span class="badge bg-{{ $parroquia->activo ? 'success' : 'danger' }}">
