...
const navItems = [
  ...
  { label: 'Mis Contratos', icon: FileText, to: '/contratos' },
  { label: 'Próximas Cuotas', icon: CalendarClock, to: '/cuotas' },
  { label: 'Reportar Pago', icon: CreditCard, to: '/pagos' },
]
        ...
        <header className="sticky top-0 z-30 border-b border-gray-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-gray-800 dark:bg-gray-900/80">
          <div className="flex h-16 items-center gap-4 px-4 sm:px-6">
            ...
            <div className="flex items-center gap-2 lg:hidden">
              ...
              <span className="font-bold text-gray-900 dark:text-white">Inversiones Danger 3000 C.A</span>
            </div>
                ...
                <DropdownMenu.Portal>
                  ...
                  >
                    <div className="px-3 py-2">
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">{window.__USER__?.name || 'Cliente'}</p>
