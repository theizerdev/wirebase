...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  if (select2.length) {
    var $this = select2;
    select2Focus($this);
    $this.select2({ placeholder: 'United States ', dropdownParent: $this.parent() });
  }
              ...
              buttons: [
                {
                  ...
                  text: '<span class="d-flex align-items-center gap-2"><i class="icon-base ri ri-upload-2-line icon-xs"></i> <span class="d-none d-sm-inline-block">Export</span></span>',
                  buttons: [
                    {
                      extend: 'print',
                ...
                {
                  text: '<span class="d-flex align-items-center gap-2"><i class="icon-base ri ri-add-line icon-sm"></i> <span class="d-none d-sm-inline-block">Add Customer</span></span>',
