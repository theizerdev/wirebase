...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_product_table = document.querySelector('.datatables-products'),
    ...
    stockObj = { 0: { title: 'Out_of_Stock' }, 1: { title: 'In_Stock' } },
    stockFilterValObj = { 0: { title: 'Out of Stock' }, 1: { title: 'In Stock' } };
          ...
          render: function (data, type, full, meta) {
            ...
            if (type === 'display') {
              let categoryBadgeObj = {
                Household:
                  '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-warning me-3"><i class="icon-base ri ri-home-6-line icon-18px"></i></span>',
                Office:
                  '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-success me-3"><i class="icon-base ri ri-briefcase-line icon-18px"></i></span>',
                Electronics:
                  '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-primary me-3"><i class="icon-base ri ri-smartphone-line icon-18px"></i></span>',
                Shoes:
                  '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-info me-3"><i class="icon-base ri ri-footprint-line icon-18px"></i></span>',
                Accessories:
                  '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-secondary me-3"><i class="icon-base ri ri-headphone-line icon-18px"></i></span>',
                Game: '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-dark me-3"><i class="icon-base ri ri-gamepad-line icon-18px"></i></span>'
              };
