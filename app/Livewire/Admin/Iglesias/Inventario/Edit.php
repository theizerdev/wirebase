...
class Edit extends Component
{
    ...
    public function mount(int $iglesiaId, int $itemId): void
    {
        $this->iglesiaId = $iglesiaId;
        $this->itemId = $itemId;

        $item = InventarioIglesia::where('iglesia_id', $iglesiaId)->where('id', $itemId)->firstOrFail();
    ...
    public function cargarTasaDelDia(): void
    {
        ...
        if ($tasa) {
            ...
            // Recalcular si hay valor en USD
            if ($this->valor) {
    ...
    public function save()
    {
        ...
        session()->flash('message', 'Ítem de inventario actualizado correctamente.');
    ...
    {
        return view('livewire.admin.iglesias.inventario.edit')
