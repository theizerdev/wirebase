...
class Edit extends Component
{
    ...
    public function mount(Cliente $cliente)
    {
        ...
        $this->empresa_id = $cliente->empresa_id;
        ...
        $this->telefono_alternativo = $cliente->telefono_alternativo;
        $this->direccion = $cliente->direccion;
        $this->ciudad = $cliente->ciudad;
        $this->estado_region = $cliente->estado_region;
        $this->ocupacion = $cliente->ocupacion;
        $this->empresa_trabajo = $cliente->empresa_trabajo;
        $this->ingreso_mensual_estimado = $cliente->ingreso_mensual_estimado;
    ...
    {
        $this->validate([
            'documento' => 'required|string|max:50|unique:clientes,documento,' . $this->cliente->id,
        ] + $this->rules);
    ...
    {
        return view('livewire.admin.clientes.edit')->layout($this->getLayout());
    }
}
